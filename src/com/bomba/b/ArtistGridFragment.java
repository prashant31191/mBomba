...
public class ArtistGridFragment extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		String strUrl = "http://semasoftltd.com/artist_images/pics.php";
		...
		mListView = (GridView)getActivity().findViewById(R.id.lv_countries);
    ...
    private class ListViewLoaderTask extends AsyncTask<String, Void, SimpleAdapter>{
		...
		protected SimpleAdapter doInBackground(String... strJson) {
	        ...
	        SimpleAdapter adapter = new SimpleAdapter(getActivity(), countries, R.layout.lv_layout, from, to);  
